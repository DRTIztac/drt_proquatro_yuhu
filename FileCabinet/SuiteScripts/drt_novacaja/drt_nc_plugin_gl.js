function customizeGlImpact(transactionRecord, standardLines, customLines, book) {
    if (book.isPrimary()) {
        try {
            ...
            nlapiLogExecution('AUDIT', 'customizeGlImpact', ' id: ' + id + ' type: ' + type);
            var line = 0;
            var objSublist = {
                line: {}
            };
            ...
            objField.custbody_drt_nc_identificador_pago = transactionRecord.getFieldValue('custbody_drt_nc_identificador_pago') || id;
            objField.custbody_drt_nc_referencia = transactionRecord.getFieldValue('custbody_drt_nc_referencia') || '';
            ...
            var idRecord = {};
            var entity_empresa = '';
            if (objField.custbody_drt_nc_identificador_uuid && objField.custbody_drt_nc_identificador_pago && !transaccion_ajuste) {
                var transaccionRepetida = searchTransaccion(objField.custbody_drt_nc_identificador_pago, objField.custbody_drt_nc_num_amortizacion);
